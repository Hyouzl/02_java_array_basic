...
public class ArrayEx01 {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		// 2. 주소 변수 (주소 저장)
		int[] arr = null; // 주소변수의 초깃값은 null 로 지정한다.
		arr = new int[5];
		...
		//배열의 최대범위를 넘어설 때 발생하는 에러
		System.out.println(arr); // 배열에는 주소값이 저장되어있다.
		...
		for (int i = 0; i < arr.length; i++) { // 배열명.length : 배열의 크기 , 길이 를 반환
